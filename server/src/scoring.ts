...
//
// This same algorithm is mirrored on the client (web/src/scoring.ts) so that
// editing the rubric recalculates scores instantly without a round-trip.
 ...
 * ~0.6 * span beyond the edge. Returns 0 for missing values.
 */
...
export function score(facts: Facts, rubric: Rubric): ScoreResult {
  ...
  // Hard exclusions — instant fail, skip the rest.
